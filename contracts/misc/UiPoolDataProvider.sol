...
contract UiPoolDataProvider is IUiPoolDataProvider {
  ...
  function _fillReserveData(
    ...
    reserveData.availableLiquidity = IERC20Detailed(reserveData.underlyingAsset).balanceOf(reserveData.mTokenAddress);
  ...
  function _fillUserReserveData(
    ...
    userReserveData.mTokenBalance = IMToken(baseData.mTokenAddress).balanceOf(user);
