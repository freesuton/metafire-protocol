 ...
 * @dev Main registry of LendPoolAddressesProvider of multiple MetaFire protocol's markets
 * - Used for indexing purposes of MetaFire protocol's markets
 * - The id assigned to a LendPoolAddressesProvider refers to the market it is connected with,
 *   for example with `1` for the MetaFire main market and `2` for the next created
 * @author MetaFire
 **/
